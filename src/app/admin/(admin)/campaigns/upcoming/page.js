...
//       try {
//         console.log("Fetching campaigns from /api/campaigns/upcoming...");
//         const response = await fetch("/api/campaigns/upcoming");
//         console.log("Response status:", response.status, response.statusText);
...
//       campaign.type === filterCategory;
//     // Removed isUpcoming to include all campaigns
//     return matchesSearch && matchesCategory;
//   })
//   .sort((a, b) => {
//     switch (sortBy) {
...
//                 {campaign.featuredImage && (
//                   <img 
//                     src={`data:${campaign.featuredImageType};base64,${Buffer.from(campaign.featuredImage).toString("base64")}`} 
//                     alt={campaign.name} 
//                     className="w-full h-full object-cover"
//                   />
//                 )}
...
//               <div className="p-4 pt-0 flex justify-between">
//                 <Link 
//                   href={`/admin/campaigns/edit/${campaign._id}`} // Updated URL to match EditCampaignPage
//                   className="px-3 py-2 bg-white/10 backdrop-blur-md rounded-lg border border-white/20 text-sm font-medium hover:bg-white/20 transition-all duration-300 flex items-center"
//                 >
//                   <Edit className="h-4 w-4 mr-2" /> Edit Details
//                 </Link>
