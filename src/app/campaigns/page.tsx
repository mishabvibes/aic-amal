...
interface RawCampaign {
  ...
  featuredImage?: string; // Optional base64 image data
  featuredImageType?: string; // Optional MIME type
  isInfinite: boolean;
  area?: string; // Optional for fixedamount
  rate?: number; // Optional for fixedamount
}
      ...
      setCampaigns(
        data.map((campaign: RawCampaign ) => {
          ...
          if (campaign.featuredImage && campaign.featuredImageType) {
            imageUrl = `data:${campaign.featuredImageType};base64,${campaign.featuredImage}`;
          }
          return {
            id: campaign._id,
            title: campaign.name,
            ...
            image: imageUrl, // Will be null if no image, handled by CampaignCard
